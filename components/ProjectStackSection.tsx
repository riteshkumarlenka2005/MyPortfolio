    ...
    <div ref={containerRef} className="h-full">
      ...
      >
        ...
        <div className="flex flex-col flex-1 p-6 sm:p-8 bg-white dark:bg-[#0a0a0a] text-parchment-900 dark:text-antique-800 relative z-10">
          ...
          {/* Links row */}
          <div className="flex flex-wrap items-center gap-3 sm:gap-4 pt-5 border-t border-parchment-400/20 dark:border-white/10 mt-auto">
            {project.liveUrl ? (
              <a
                ...
                className="relative inline-flex items-center justify-center p-[1px] rounded-lg overflow-hidden group/btn hover:shadow-[0_0_15px_rgba(168,85,247,0.4)] transition-shadow duration-300"
              >
                <span className="absolute inset-0 bg-gradient-to-r from-amber-500 via-purple-500 to-cyan-400 opacity-70 group-hover/btn:opacity-100 transition-opacity duration-300" />
                <span className="relative flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-white dark:bg-[#0a0a0a] text-parchment-900 dark:text-white rounded-[7px] font-serif text-xs sm:text-sm font-bold uppercase tracking-wider transition-colors duration-300 group-hover/btn:bg-parchment-50 dark:group-hover/btn:bg-[#141414]">
              ...
              <span className="relative inline-flex items-center justify-center p-[1px] rounded-lg overflow-hidden opacity-50 cursor-not-allowed grayscale">
                <span className="absolute inset-0 bg-gradient-to-r from-amber-500 via-purple-500 to-cyan-400 opacity-70" />
                <span className="relative flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-white dark:bg-[#0a0a0a] text-parchment-900 dark:text-white rounded-[7px] font-serif text-xs sm:text-sm font-bold uppercase tracking-wider">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5"><path strokeLinecap="round" strokeLinejoin="round" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101" /><path strokeLinecap="round" strokeLinejoin="round" d="M10.172 13.828a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" /></svg>
                  Live Demo
                </span>
              </span>
            ...
            {/* Explore arrow */}
            <span className="ml-auto flex items-center gap-1.5 text-parchment-900 dark:text-white">
