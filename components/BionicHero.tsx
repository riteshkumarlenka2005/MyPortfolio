...
export const BionicHero: React.FC = () => {
    ...
    // When navigating back via Home/Archivist the flag is still set at render time.
    // Skip entrance animations so the hero appears immediately with no fade delay.
    const skipAnim = !!(window as any).__scrollToHero;
    return (
        <section className="w-full h-screen bg-black flex items-center justify-center font-sans overflow-hidden">
            <div className="w-full h-full bg-[#f0f0f4] p-3 lg:p-5 flex flex-col lg:flex-row gap-4 shadow-2xl overflow-hidden relative">
                ...
                <div className="flex-1 lg:max-w-[50%] h-full flex flex-col justify-between pt-1 pb-4 px-2 lg:pr-6 lg:pl-0 z-10 relative">
                    ...
                    <div className={`flex flex-col justify-center flex-1 py-2 lg:py-8 px-4 lg:px-0 lg:-ml-12 -mt-10 lg:-mt-20${skipAnim ? '' : ' animate-fade-in-up'}`} style={skipAnim ? {} : { animationDelay: '0.15s', animationFillMode: 'both' }}>
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-start w-full gap-4 lg:gap-6 lg:-ml-12 pb-6 translate-y-2 lg:translate-y-4">
                        ...
                        {/* Social Links */}
                        <div className={`flex items-center gap-3 lg:ml-auto lg:mr-12${skipAnim ? '' : ' animate-fade-in-up'}`} style={skipAnim ? { transform: 'translateY(-100px)' } : { animationDelay: '0.3s', animationFillMode: 'both', transform: 'translateY(-100px)' }}>
                            <a href="https://github.com/riteshkumarlenka2005" target="_blank" rel="noreferrer" className="w-11 h-11 rounded-full bg-white/10 border border-white/20 hover:bg-white text-white hover:text-black flex items-center justify-center transition-all shadow-sm">
                            ...
                            <a href="https://www.linkedin.com/in/ritesh-kumar-lenka-186010320/" target="_blank" rel="noreferrer" className="w-11 h-11 rounded-full bg-white/10 border border-white/20 hover:bg-[#0077b5] text-white hover:text-white flex items-center justify-center transition-all shadow-sm">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                                </svg>
                            </a>
                            <a href="mailto:lenkariteshkumar2005@gmail.com" className="w-11 h-11 rounded-full bg-white/10 border border-white/20 hover:bg-[#EA4335] text-white hover:text-white flex items-center justify-center transition-all shadow-sm">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
