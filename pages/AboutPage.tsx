    ...
    return (
      ...
      `}>
                ...
                <header className="mb-16 border-b border-white/10 pb-8">
                    ...
                    <h2 className="font-sans text-3xl md:text-4xl font-bold tracking-wide text-white">
                ...
                <section className="mb-16">
                    <div className="font-serif text-lg md:text-xl leading-relaxed space-y-6 text-justify text-gray-300">
                ...
                {/* Decorative Divider */}
                <div className="flex items-center justify-center gap-6 my-16 opacity-30 text-white">
                ...
                <section className="mb-16">
                    <h2 className="font-sans text-2xl font-bold mb-8 flex items-center gap-4 text-white">
                        <span className="text-amber-500/50 text-4xl font-light">I.</span>
                        My Story & Academic Journey
                    </h2>
                    <div className="font-serif text-lg leading-relaxed space-y-6 text-justify text-gray-300">
                        <p>
                ...
                <div className="mb-16 w-[94vw] max-w-[1600px] relative left-1/2 -translate-x-1/2 rounded-[2.5rem]">
                    <TimelineSection />
                </div>
                ...
                <section className="mb-16">
                    <h2 className="font-sans text-2xl font-bold mb-8 flex items-center gap-4 text-white">
                        <span className="text-amber-500/50 text-4xl font-light">II.</span>
                        Technical Interests
                    </h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {[
                            ...
                            <div
                                key={i}
                                className="p-6 border border-white/10 hover:border-amber-500/30 transition-colors duration-500 rounded-lg bg-white/5"
                            >
                                <h3 className="font-sans font-bold text-lg mb-3 text-white">{item.title}</h3>
                                <p className="font-serif text-base leading-relaxed text-gray-300">{item.desc}</p>
                            </div>
                        ))}
                    </div>
                </section>
                ...
                <section className="mb-16">
                    <h2 className="font-sans text-2xl font-bold mb-8 flex items-center gap-4 text-white">
                        <span className="text-amber-500/50 text-4xl font-light">III.</span>
                ...
                <section className="mb-16">
                    <h2 className="font-sans text-2xl font-bold mb-8 flex items-center gap-4 text-white">
                        <span className="text-amber-500/50 text-4xl font-light">IV.</span>
                ...
                <section className="border-t border-white/10 pt-12 mt-20">
                    <h2 className="font-sans text-2xl font-bold mb-6 text-white">Correspondence</h2>
                    <p className="font-serif text-lg leading-relaxed mb-8 text-gray-300">
                    ...
                    <div className="flex flex-wrap gap-6 text-white">
                        <a
                            ...
                            className="group font-serif text-lg border-b border-transparent hover:border-amber-500 transition-colors duration-300"
                        >
